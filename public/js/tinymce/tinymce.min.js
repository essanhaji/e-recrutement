    ...
    r(l, [], function() {
            ...
            function w(t, n, r) {
                ...
                function c(e, r, a) {
                    ...
                    l = f.inline || f.block, c = Q.create(l), i(c), ee.walk(e, function(e) {
                        ...
                        if (!ne(e) && !H(e, "fontSize")) {
                            var c = a(e, P("fontSize"));
                            c && w("fontsize", {
                                value: H(c, "fontSize")
                            }, e)
                        }(f.inline || f.wrapper) && (f.exact || 1 !== u || (e = l(e)), me(d, function(t) {
        ...
        return function(e) {
            function t() {
                ...
                if (C = n.forced_root_block, t && 1 === t.nodeType && C) {
                    ...
                    if (g && v) {
                        if (l.setStart) l.setStart(u, c),
                            l.setEnd(d, f), i.setRng(l);
                        else try {
            ...
            function J() {
                function t(e) {
                    var t = new d(e.getBody()),
                        ...
                        i = c.fromRangeStart(r),
                        o = c.fromRangeEnd(r),
                        a = t.prev(i),
                        s = t.next(o);
                    return !e.selection.isCollapsed() && (!a || a.isAtStart() && n(i, a) === !1) && (!s || s.isAtEnd() && n(i, s) === !1)
                }
                var n = function(e, t) {
                    return e.getNode() === t.getNode() || e.isEqual(t)
                };
                f.on("keypress", function(n) {
        ...
        function v(u) {
            ...
            function H(e, t, n) {
                ...
                if (h = N(n), r = M(e, n), i = t(re, a.isAboveLine(1), r), o = p.filter(i, a.isLine(1)), u = p.last(r.getClientRects()), E(r) && (h = r.getNode()), w(r) && (h = r.getNode(!0)), !u) return null;
                if (c = u.left, l = s.findClosestClientRect(o, c), l && C(l.node)) return d = Math.abs(c - l.left), f = Math.abs(c - l.right), A(e, l.node, d < f);
                if (h) {
                    var m = a.positionsUntil(e, re, a.isAboveLine(1), h);
            ...
            function I(t, r) {
                ...
                if (r.collapsed && u.settings.forced_root_block) {
                    ...
                    a = 1 == t ? oe(n.fromRangeStart(r)) : ae(n.fromRangeStart(r)), a || (s = i(), 1 == t ? u.$(o).after(s) : u.$(o).before(s), u.selection.select(s, !0), u.selection.collapse())
                }
            }
            ...
            function V(e) {
                var t, r;
                return e = i.normalizeRange(1, re, e), t = n.fromRangeStart(e), C(t.getNode()) ? A(1, t.getNode(), !t.isAtEnd()) : C(t.getNode(!0)) ? A(1, t.getNode(!0), !1) : (r = u.dom.getParent(t.getNode(), f.or(C, b)), C(r) ? A(1, r, !1) : null)
            }
            ...
            function q(e) {
                var t, i, o, a;
                return C(e) ? (C(e.previousSibling) && (o = e.previousSibling), i = ae(n.before(e)), i || (t = oe(n.after(e))), t && x(t.getNode()) && (a = t.getNode()), r.remove(e.previousSibling), r.remove(e.nextSibling), u.dom.remove(e), u.dom.isEmpty(u.getBody()) ? (u.setContent(""), void u.focus()) : o ? n.after(o).toRange() : a ? n.before(a).toRange() : i ? i.toRange() : t ? t.toRange() : null) : null
            }
            ...
            function G() {
                ...
                u.on("mouseup", function() {
                    ...
                    var t;
                    t = o(e.target), t && (C(t) && (e.preventDefault(), u.focus()), b(t) && u.dom.isChildOf(t, u.selection.getNode()) && ee())
                ...
                f(u), u.on("mousedown", function(e) {
                    var t;
                    if (t = o(e.target)) C(t) ? (e.preventDefault(), Z(B(t))) : l(e.clientX, e.clientY, u.selection.getRng()) || u.selection.placeCaretAt(e.clientX, e.clientY);
                    else {
                        ee(), ne();
                    ...
                    var t = e.range;
                    if (ue) {
                        if (!ue.parentNode) return void(ue = null);
                        t = t.cloneRange(), t.selectNode(ue), e.range = t
                    }
            ...
            var re = u.getBody(),
                ...
                oe = y(g, ie.next),
                ae = y(g, ie.prev),
                se = new o(u.getBody(), S),
                le = "sel-" + u.dom.uniqueId(),
                ue, ce = u.$;

        ...
        <section class="ptb80 titlePobPost" id="job-post">
            <div class="container">
                ...
                <div class="section-title" style="margin-top: -5px;">
                    <h2 class="capitalize" style="text-align: center"><i class="fa fa-pencil"></i>&nbsp;modifier mon profil</h2>
                </div>


                <div class="col-md-12 col-sm-12 col-xs-12 job-post-main">

                            <form class="form-horizontal" method="POST" action="{{ url('candidate/candidate-profile-update') }}" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                    ...
                                    <div class="">
                                        <div class="col-md-6">
                                            <div class="form-group{{ $errors->has('first_name') ? ' has-error' : '' }}">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" name="first_name" value="{{ $candidate->first_name }}{{ old('first_name') }}" placeholder="votre nom" required autofocus>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group{{ $errors->has('last_name') ? ' has-error' : '' }}">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" name="last_name" value="{{ $candidate->last_name }}{{ old('last_name') }}" placeholder="votre prenom" required>
                                ...
                                <div class="form-group{{ $errors->has('address') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" name="address" value="{{ $cv->address }}{{ old('address') }}" placeholder="ville, cartier, N°" required>
                                ...
                                <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-8">
                                        <input type="email" class="form-control" name="email" value="{{ $cv->email }}{{ old('email') }}" placeholder="exemple@exemple.com" required>
                                ...
                                <div class="form-group{{ $errors->has('phone_number') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-8">
                                            <input type="tel" class="form-control" name="phone_number" value="{{ $cv->phone_number }}{{ old('phone_number') }}" required size="10" minlength="10" maxlength="10" placeholder="06 xx xx xx xx">
                                ...
                                <div class="form-group{{ $errors->has('picture') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-8">
                                            <input type="file" class="form-control" name="picture" accept=".jpg,.png,.gif,.bmp,.tiff,.jpeg">
                                ...
                                <div class="form-group{{ $errors->has('facebook') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-8">
                                        <input id="facebook" type="url" class="form-control" value="{{ $cv->facebook }}{{ old('facebook') }}" name="facebook" placeholder="http://your-facebook-page.com/">
                                ...
                                <div class="form-group{{ $errors->has('insagram') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-8">
                                            <input id="insagram" type="url" class="form-control" value="{{ $cv->insagram }}{{ old('insagram') }}" name="insagram" placeholder="http://your-instagram.com/">
                                ...
                                <div class="form-group{{ $errors->has('twitter') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-8">
                                            <input id="twitter" type="url" class="form-control" name="twitter" placeholder="http://your-twitter.com/" value="{{ $cv->twitter }}{{ old('twitter') }}">
                                ...
                                <div class="form-group{{ $errors->has('google_plus') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-8">
                                            <input id="google_plus" type="url" class="form-control" name="google_plus" placeholder="http://your-google-plus.com/" value="{{ $cv->google_plus }}{{ old('google_plus') }}">
                                ...
                                <div class="form-group{{ $errors->has('linkedin') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-8">
                                            <input id="linkedin" type="url" class="form-control" name="linkedin" placeholder="http://your-linkedin.com/" value="{{ $cv->linkedin }}{{ old('linkedin') }}">
                                ...
                                <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" name="title" value="{{ $cv->title }}{{ old('title') }}" placeholder="développeur" required>
                                ...
                                <div class="form-group{{ $errors->has('experience') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-8">
                                        <select name="experience" class=" form-control" data-live-search="true" title="niveau d'experience" data-size="5" data-container="body" required>
                                            <option value="{{ $cv->experience }}" selected>{{ $cv->experience }}</option>
                                ...
                                <div class="form-group{{ $errors->has('etude') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-8">
                                        <select name="etude" class=" form-control" data-live-search="true" title="niveau d'etudes" data-size="5" data-container="body" required>
                                            <option value="{{ $cv->etude }}" selected>{{ $cv->etude }}</option>
                                ...
                                <div class="form-group{{ $errors->has('salary') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-8">
                                        <input type="number" class="form-control" name="salary" value="{{ $cv->salary }}{{ old('salary') }}" placeholder="0 DH" min="0" max="99999999" required>
                                ...
                                <div class="form-group{{ $errors->has('age') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-8">
                                        <input type="number" class="form-control" name="age" value="{{ $cv->age }}{{ old('age') }}" placeholder="20  Annes" min="15" max="100" required>
                                ...
                                <div class="form-group{{ $errors->has('civility') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-8">
                                        <select name="civility" class=" form-control" data-live-search="true" title="touts civility" data-size="5" data-container="body" required>
                                            <option value="{{ $candidate->civility }}" hidden selected>{{ $candidate->civility }}</option>
                                ...
                                <div class="form-group{{ $errors->has('about_me') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-8">
                                            <textarea class="form-control" name="about_me" value="{{ old('about_me') }}" rows="5" placeholder="a propo de moi" required>{{ $cv->about_me }}</textarea>
                                ...
                                <div class="form-group{{ $errors->has('birthdate') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-8">
                                            <input class="form-control" name="birthdate" type="date" value="{{ $candidate->birthdate }}{{ old('birthdate') }}"  max="<?php=date('m/d/Y'); ?>" required>
                                ...
                                <div class="form-group{{ $errors->has('active') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-5"> 
                                        <label class="switch">
                                            <input class="form-control" name="active" type="checkbox" value="true" @if($cv->active == 'true') checked @endif>

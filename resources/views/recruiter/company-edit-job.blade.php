        ...
        <section class="ptb80 titlePobPost" id="job-post">
            <div class="container">
                ...
                <div class="section-title" style="margin-top: -5px;">
                    <h2 class="capitalize" style="text-align: center"><i class="fa fa-pencil"></i>&nbsp;modifier une annonce</h2>
                </div>
                <div class="col-md-12 col-sm-12 col-xs-12 job-post-main">


                        <form class="form-horizontal" method="POST" action="{{ url('recruiter/company-job-update/'.$job->id) }}">
                                {{ csrf_field() }}
                                <br>
                                ...
                                <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" name="title" value="{{ $job->title }}{{ old('title') }}" placeholder="le tite de l'annonce" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('number_post') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-8">
                                        <input type="number" class="form-control" name="number_post" value="{{ $job->number_post }}{{ old('number_post') }}" placeholder="0000" min="1" max="9999" required>                                        
                                ...
                                <div class="form-group{{ $errors->has('city') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-8">
                                        <select name="city" class=" form-control" data-live-search="true" title="touts les villes" data-size="5" data-container="body" required>
                                            <option style="color:black" value="{{ $job->city }}" selected > {{ $job->city }} </option>
                                ...
                                <div class="form-group{{ $errors->has('type_contract') ? ' has-error' : '' }}">
                                        ...
                                        <select name="type_contract" class=" form-control" data-live-search="true" title="touts le stype de contrat" data-size="5" data-container="body" required>
                                            <option value="{{ $job->type_contract }}" selected>{{ $job->type_contract }}</option>
                                ...
                                <div class="form-group{{ $errors->has('experience') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-8">
                                        <select name="experience" class=" form-control" data-live-search="true" title="niveau d'experience" data-size="5" data-container="body" required>
                                            <option value="{{ $job->experience }}" selected>{{ $job->experience }}</option>
                                ...
                                <div class="form-group{{ $errors->has('categorie') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-8">
                                        <select name="categorie" class=" form-control" data-live-search="true" title="touts categorie" data-size="5" data-container="body" required>
                                            <option value="{{ $job->categorie }}" selected>{{ $job->categorie }}</option>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group{{ $errors->has('salary_min') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-md-6">
                                                <input type="number" class="form-control" name="salary_min" value="{{ $job->salary_min }}{{ old('salary_min') }}" placeholder="0 DH" min="1" max="9999999" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group{{ $errors->has('salary_max') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-md-6">
                                                <input type="number" class="form-control" name="salary_max" value="{{ $job->salary_max }}{{ old('salary_max') }}" placeholder="0 DH" min="1" max="99999999" required>
                                ...
                                <div class="form-group{{ $errors->has('description_post') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-8">
                                            <textarea class="form-control" name="description_post" value="{{ old('description_post') }}" rows="4" placeholder="une description sur le poste" required>{{ $job->description_post }}</textarea>
                                ...
                                <div class="form-group{{ $errors->has('key_requirement') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-8">
                                            <textarea class="form-control" name="key_requirement" value="{{ old('key_requirement') }}" rows="4" placeholder="les exigences principales por ce poste" required>{{ $job->key_requirement }}</textarea>
                                ...
                                <div class="form-group{{ $errors->has('our_offer') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-8">
                                            <textarea class="form-control" name="our_offer" value="{{ old('our_offer') }}" rows="4" placeholder="nous offrons" required>{{ $job->our_offer }}</textarea>
                                ...
                                <div class="form-group{{ $errors->has('end_date') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-8">
                                        <input class="form-control" name="end_date" type="date" value="{{ $job->end_date }}{{ old('our_offer') }}"  min="<?php=date('m/d/Y'); ?>" required>
                                        @if ($errors->has('our_offer'))
                                            <span class="help-block">
                                ...
                                <div class="form-group{{ $errors->has('active') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-5"> 
                                        <label class="switch">
                                            <input class="form-control" name="active" type="checkbox" value="true" @if($job->active == 'true') checked @endif >

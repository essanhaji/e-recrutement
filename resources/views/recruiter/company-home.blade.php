            ...
            <div class="container">
                ...
                <div class="col-md-7">
                        <ul class="nav navbar-nav centered">
                                <!-- accueil Menu Item -->
                                <li class="simple-menu">
                                    <a href="{{url('/recruiter/company-home')}}" role="button"  style="color:#29b2fe">mes annonces</a>
                                </li>
    ...
    <section class="ptb80 titlePobPost" id="job-post">
        <div class="container">
            ...
            <div class="section-title" style="margin-top: -5px;">
                <h2 class="capitalize" style="text-align: center"><i class="fa fa-bullhorn"></i>&nbsp;Mes Offres</h2>
            </div>
                ...
                <div class="job-post-wrapper mt60">
                    ...
                    <div class="single-job-post row nomargin">
                        ...
                        <div class="col-md-8 col-xs-6 ptb20">
                            ...
                            <div class="job-info">
                                <span class="company"><i class="fa fa-building-o"></i>{{ $recruiter[0]->name_entreprise }}</span>
